<?php
    ...
    $rep .= "                            </div>";
    $rep .= "                            <div class=\"form-group row\">";
    $rep .= "                                <label for=\"nomParticipant\" class=\"col-sm-2 col-form-label\">Pays</label>";
    $rep .= "                                <div class=\"col-sm-10\">";
    $rep .= "                                    <select name=\"country\" class=\"form-control\"  id=\"sexeParticipant\" name=\"paysParticipant\" required>";
