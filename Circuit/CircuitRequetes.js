...
strVar += "            <br \/>";
strVar += "<a>	<img src='pochettes/" + "8fec20818bcb9334ebfee5e45dc3657f3185aaae.jpg"+ "' style='width:460px; height:500px;'></a>";
strVar += "";
strVar += "";
...
strVar += "                        <td style=\"background-color: #426CB4; color: white\">500 $<\/td>";
strVar += "                    <\/tr>";
strVar += "                    <tr style=\" height: 30px\">";
...
strVar += "                            <\/li>";
strVar += "                            <li class=\"nav-item\">";
strVar += "                                <a class=\"nav-link disabled\" href=\"#\" style=\"color: black\">Réservations<\/a>";
strVar += "                            <\/li>";
strVar += "                        <\/ul>";
strVar += "                    <\/div>";
