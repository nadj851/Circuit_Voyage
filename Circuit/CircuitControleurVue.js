...
alert(fiche[0].titre);
    ...
    input += "                                                        <input type=\"text\" class=\"form-control\" id=\"nomCircuit\" name=\"nomCircuit\"  value = " + fiche[0].titre + " required>";
    ...
    input += "                                                    <label for=\"dateDepartCircuit\" class=\"col-sm-2 col-form-label\">Date de départ<\/label>";
    input += "                                                    <div class=\"col-sm-10\">";
    input += "                                                        <input type=\"text\" class=\"form-control\" id=\"dateDepartCircuit\" name=\"dateDepartCircuit\"  required  value = " + fiche[0].dateDeDepart + " >";
    input += "                                                    <\/div>";
    input += "                                                <\/div>";
    input += "";
    input += "";
    ...
    input += "                                                    <div class=\"col-sm-10\">";
    input += "                                                        <input type=\"text\" class=\"form-control\" id=\"dateRetourCircuit\" name=\"dateRetourCircuit\" placeholder=\"Entrer retour date\" required value = " + fiche[0].dateDeRetour + " >";
    input += "                                                    <\/div>";
    input += "                                                <\/div>";
    input += "";
    input += "";
    ...
    input += "                                                    <label for=\"nbPersonneMin\" class=\"col-sm-2 col-form-label\">Nombre personnes minimum<\/label>";
    input += "                                                    <div class=\"col-sm-10\">";
    input += "                                                        <input type=\"text\" class=\"form-control\" id=\"nbPersonneMin\" name=\"nbPersonneMin\" placeholder=\"Entrer courriel du participant\" required value = " + fiche[0].nbPersonnesMin + " >";
    input += "                                                    <\/div>";
    input += "                                                <\/div>";
    input += "";
    input += "";
    ...
    input += "                                                    <label for=\"nbPersonneMax\" class=\"col-sm-2 col-form-label\">Nombre personnes maximum<\/label>";
    input += "                                                    <div class=\"col-sm-10\">";
    input += "                                                        <input type=\"text\" class=\"form-control\" id=\"nbPersonneMax\" name=\"nbPersonneMax\" placeholder=\"Entrer courriel du participant\" required value = " + fiche[0].nbPersonnesMax + " >";
    input += "                                                    <\/div>";
    input += "                                                <\/div>";
    input += "";
    input += "";
    ...
    input += "                                                    <label for=\"prixCircuit\" class=\"col-sm-2 col-form-label\">Prix<\/label>";
    input += "                                                    <div class=\"col-sm-10\">";
    input += "                                                        <input type=\"text\" class=\"form-control\" id=\"prixCircuit\" name=\"prixCircuit\" required value = " + fiche[0].prix + " >";
    input += "                                                    <\/div>";
    input += "                                                <\/div>";
    input += "";
    input += "                                                <div class=\"form-group row\">";
    input += "                                                    <label for=\"descripCircuit\" class=\"col-sm-2 col-form-label\">Déscription du circuit<\/label>";
    input += "                                                    <div class=\"col-sm-10\">";
    input += "                                                        <textarea class=\"form-control\" rows=\"5\" id=\"descripCircuit\" name=\"descripCircuit\">"+fiche[0].description+"<\/textarea>";
    input += "";
    input += "";
    input += "";
    input += "                                                    <\/div>";
    ...
    input += "                                                      <input type=\"file\" class=\"form-control-file\" id=\"pochette\" name=\"pochette\" aria-describedby=\"fileHelp\">";
    input += "  <input type=\"hidden\" name=\"idCircuit\" value="+ fiche[0].idCircuit+">";
    input += "                                          <\/div>";
